    ...
    methods: {
        loadItems: function() {
            ...
            axios.get(
                    ...
                    "https://api.airtable.com/v0/" + app_id + "/results?fields%5B%5D=profileCode&fields%5B%5D=inst-full&fields%5B%5D=4*&fields%5B%5D=3*&fields%5B%5D=2*&fields%5B%5D=1*&fields%5B%5D=N%2FC&fields%5B%5D=staff-a&fields%5B%5D=array&fields%5B%5D=code&fields%5B%5D=inst&fields%5B%5D=uoa&fields%5B%5D=year&fields%5B%5D=Profile&fields%5B%5D=ref-cs-url&view=uoa-cs-shortlist", {
                        headers: {
                    ...
                    for (j in obj) {
                        ...
                        if (k === null) {
                            h.insertAdjacentHTML("beforeend",
                                ...
                                '<div class="rotate">\n' +
                                '<h1 class="has-text-grey-dark has-text-weight-semibold is-size-7"><a href="' + obj[j].fields['ref-cs-url'] + '" target="_blank">' + obj[j].fields['inst'] + '</a></h1>\n' +
                                '</div>\n' +
                                '</div>\n' +
