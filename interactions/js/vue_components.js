...
Vue.component('author-details', {
    ...
    <div>
        ...
        <br>
    <span class="font-weight-light small">{{ content }}</span>:&nbsp;<span class="font-weight-light small"><a v-if="type=='Column'" v-bind:href="'https://airtable.com/shr0sfqAldfNfkIs7?prefill_Status=Pending&prefill_Type=Column&prefill_Title%20of%20text=' + encodeURIComponent(content) + '&prefill_Contact%20Author=' + encodeURIComponent(name)" target="_blank">submission form</a><a v-else-if="type=='Forum'" v-bind:href="'https://airtable.com/shr0sfqAldfNfkIs7?prefill_Status=Pending&prefill_Type=Forum&prefill_Title%20of%20text=' + encodeURIComponent(content) + '%20&prefill_Sub%20Editor=' + encodeURIComponent(name)" target="_blank">submission form</a><a v-else href="https://airtable.com/shr0sfqAldfNfkIs7?prefill_Status=Pending" target="_blank">general form</a></span>
    </div>`
})
