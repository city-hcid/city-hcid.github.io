        ...
        <div v-bind:id="item['project-name']" v-if="item['project-name']" class="my-5">
            ...
            <div>
                ...
                <p class="pb-5">
                    ...
                    <span v-if="item['lead']" class="lbr grey-text text-darken-2"><a v-bind:href="item['lead-url']">{{ item['lead-str'] }}</a> (lead)</span><span v-if="item['members']" class="lbr grey-text text-darken-2">, {{ item['members-str'] }}</span><span v-if="item['collaborators'] && item['collaborators-long']" class="lbr grey-text text-darken-2">, {{ item['collaborators-long'] }}</span><span v-else-if="item['collaborators'] && item['collaborators-long']===null" class="lbr grey-text text-darken-2">, {{ item['collaborators'] }}</span><span v-else> </span>
                </p>
            </div>
        </div>
    `
